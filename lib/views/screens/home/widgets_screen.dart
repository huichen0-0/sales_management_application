...
class WidgetScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: FutureBuilder<Users?>( //Đưa vào builder để lấy thông tin người dùng từ BE
        future: authController.getUserInfo(), // Gọi phương thức lấy thông tin người dùng
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            return Center(child: Text('Lỗi khi lấy thông tin người dùng')); // Xử lý lỗi
          }
          ...
          return ListView(
            ...
            children: [
              _buildAccountInfoCard(
                ...
                user?.fullName ?? 'Không có tên', // Hiển thị tên người dùng
                user?.email ?? 'Không có email', // Hiển thị email người dùng
              ),
              WidgetCard(
                title: 'Giao dịch',
                items: [
  ...
  Widget _buildAccountInfoCard(
      BuildContext context, List<Map<String, dynamic>> items, String fullName, String email) {
    return Card(
      color: Colors.white,
